...
class CartRobot {
  ...
  Future<void> incrementCartItemQuantity({required int quantity, required int atIndex}) async {
  ...
  Future<void> decrementCartItemQuantity({required int quantity, required int atIndex}) async {
